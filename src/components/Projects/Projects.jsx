...
import { navLinks, PROJECTS } from "../constants/index";
...
const Projects = ({ isDesktop, clientHeight }) => {
  ...
  return (
    <section
      ...
      } w-full max-w-full relative select-none  2xl:px-2 xl:px-4 md:px-4 px-0 mx-auto transform-gpu`}
      id={navLinks[2].ref}
    >
      <div className="flex flex-col  justify-center  h-full">
        <div
          className="flex flex-col inner-container p-8 transform-gpu md:px-4"
          ref={sectionTitle}
        >
          <p className="uppercase tracking-widest text-white seq">PROJECTS</p>
          <h1 className="text-6xl  mt-2 font-medium text-gradient w-fit seq">
            My Projects
          </h1>
          <h2 className="text-secondary text-xl sm:text-2xl lg:text-3xl font-medium md:max-w-lg max-w-sm mt-2 px-1 seq">
        ...
        <div
          ...
          } flex project-wrapper px-8 sm:pl-6  w-fit seq`}
        >
